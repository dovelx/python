...
caseinfo['data'] =data
testsuit13.append(caseinfo.copy())
...
print("topEntityId（安全分析步骤添加）",topEntityId)
print("jsaidx（安全分析步骤添加）",jsaidx)
#http://192.168.6.156/hse/HSE_SAFETY_TASK/cardSave?parentEntityId=&parentFuncCode=&topEntityId=2000000000963&topFuncCode=HSE_SAFETY_TASK&dataId=2000000000963&0.5657250541162973&contentType=json&ajax=true&tid=2000000001003
url=  'http://192.168.6.156/hse/HSE_SAFETY_TASK/cardSave?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_SAFETY_TASK&dataId=%d&0.5657250541162973&contentType=json&ajax=true&tid=2000000001003'%(topEntityId,topEntityId)
#url = 'http://192.168.6.156/hse/HSE_SAFETY_ANALYSIS/cardSave?parentEntityId=2000000000876&parentFuncCode=HSE_SAFETY_TASK&topEntityId=2000000000876&topFuncCode=HSE_SAFETY_TASK&dataId=2000000000836&0.6015172226353962&contentType=json&ajax=true&tid=2000000001003'
...
data = {
	...
	"worktaskid": topEntityId,
	"recordnumber": "",
	"worknumber": "炼油一_AQFX20200707005",
...
caseinfo['id'] = 8
caseinfo['name'] = casename
topEntityId = topEntityId -1
#http://192.168.6.156/hse/HSE_SAFETY_TASK/listDeleteBatch?parentEntityId=&parentFuncCode=&topEntityId=2000000000967&topFuncCode=HSE_SAFETY_TASK&0.44291176509757313&contentType=json&ajax=true&tid=2000000001003
url = 'http://192.168.6.156/hse/HSE_SAFETY_TASK/listDeleteBatch?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_SAFETY_TASK&0.44291176509757313&contentType=json&ajax=true&tid=2000000001003'%(topEntityId)
data = [topEntityId]
caseinfo['url'] = url
caseinfo['data'] =data
testsuit13.append(caseinfo.copy())
