...
case = '长岭项目作业许可-PC-预约-安全-作业任务提交，修改，删除'
...
caseinfo['id'] = 10
caseinfo['name'] = casename
#http://192.168.6.156/hse/HSE_WORK_TASK/cardSave?parentEntityId=&parentFuncCode=&topEntityId=2000000002918&topFuncCode=HSE_WORK_TASK&dataId=2000000002918&0.35392240460073277&contentType=json&ajax=true&tid=2000000001003
url = 'http://192.168.6.156/hse/HSE_WORK_TASK/cardSave?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_WORK_TASK&dataId=%d&0.35392240460073277&contentType=json&ajax=true&tid=2000000001003'%(worktaskidx,worktaskidx)
jsaidx= jsaid+1
data = {
	"tableName": "hse_work_task",
	"task_worktype_code": "",
	...
	"workname": "modify",
	"work_position_name": "炼油一部",
	"work_appoint_name": "Created_by_Python_LupZ6o",
	"actualstarttime": "",
	"actualendtime": "",
	"isgas_detection": "",
	"delayreason": "",
	...
	"safecode": "",
	"work_position_id": 2000000001791,
	"jsa_code": "聚丙烯_AQFX20200624004",
	"jsaid": 2000000000885,
	"work_appoint_id": 2000000000435,
	"wf_current_nodeid": "",
	"wf_audit_time": "",
	"task_risklevel": "",
	"task_closereason": "",
...
#作业任务提交接口用例信息
worktaskidx = worktaskidx-1
casename = '作业任务删除'
caseinfo['id'] = 11
caseinfo['name'] = casename
#http://192.168.6.156/hse/HSE_WORK_TASK/listDeleteBatch?parentEntityId=&parentFuncCode=&topEntityId=2000000002918&topFuncCode=HSE_WORK_TASK&dataId=2000000002918&0.8189582015732326&contentType=json&ajax=true&tid=2000000001003
url = 'http://192.168.6.156/hse/HSE_WORK_TASK/listDeleteBatch?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_WORK_TASK&dataId=%d&0.8189582015732326&contentType=json&ajax=true&tid=2000000001003'%(worktaskidx,worktaskidx)
jsaidx= jsaid+1
data =[worktaskidx]
caseinfo['url'] = url
caseinfo['data'] =data
