...
<script>
    ...
    import {getReportInfo, getTestReportDetail, getTestCaseReports} from "../../../api/testReport";
    ...
    export default {
        ...
        methods: {
            ...
            showDetail(row) {
                let self = this;
                getTestReportDetail(row.reportId, row._id).then(res => {
                    if (res.status == 'ok') {
                        let detail = res.data.resultDetail
