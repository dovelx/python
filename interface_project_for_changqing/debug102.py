...
url1 = 'http://192.168.6.27:6030/hse/HSE_WORK_APPOINT/getMetaData?0.3897117454385264&contentType=json&ajax=true&tid=1'
url = 'http://192.168.6.27:6030/hse/HSE_WORK_TASK_MCQ/getMetaData?0.9361492698096476&contentType=json&ajax=true&tid=1'
#请求头
headers={
...
# url = 'http://192.168.6.27:6030/hse/HSE_WORK_TASK_MCQ/getMetaData?0.9361492698096476&contentType=json&ajax=true&tid=1'
# #安全分析列报表
# url = 'http://192.168.6.27:6030/hse/HSE_SAFETY_TASK_RISK/getMetaData?0.1772610700060453&contentType=json&ajax=true&tid=1'
# #请求头
# headers={
#     'Accept': 'application/json, text/javascript, */*; q=0.01',
#     'csrf': '6363382b59f6435eb243fab57ea5a5e0',
...
#         for a in data:
#             #print("\n\n",a)
#             if a['work_appoint_name']  == "Created_by_Python_t4DYe9":
#                 #print(a)
