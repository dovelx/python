...
caseinfo['data'] =data
testsuit7.append(caseinfo.copy())
...
url = 'http://192.168.6.27:6030/hse/HSE_SAFETY_TASK_RISK/listDeleteBatch?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_SAFETY_TASK_RISK&dataId=%d&0.2964446119500741&contentType=json&ajax=true&tid=1'%(jsaidxx,jsaid)
data = [jsaidxx]
caseinfo['url'] = url
caseinfo['data'] =data
testsuit7.append(caseinfo.copy())