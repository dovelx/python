...
#临时cookies
cookies={'JSESSIONID': '40BC97F42E86FBE3F5020B87D2F1C1336JYuOM'}
print(cookies)
...
#作业预约复制
#name = ranstr(7)
#work_appoint_id_l = work_appoint_id_l + 1
url = "http://192.168.6.27:6030/hse/HSE_WORK_APPOINT/cardSave?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_WORK_APPOINT&dataId=%d&0.6280400811634435&contentType=json&ajax=true&tid=1"%(work_appoint_id_l,work_appoint_id_l)
