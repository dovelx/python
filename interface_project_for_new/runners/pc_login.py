...
def login2():
    cookies = {'JSESSIONID': 'E3F050FB025721015138B9825E2950BFDMMkMu'}
...
def login():
    ...
    import json
    #访问1-主页
    url = 'http://v3-test-linux-portal.hd-cloud.com/hd'
    headers = {
    ...
    print("1-cookies==",cookies)
    searchObj = re.search("jsessionid_portal=(.+?);", cookies, re.M | re.I)
    if searchObj:
        # print("searchObj.group() : ", searchObj.group())
        # print("searchObj.group(1) : ", searchObj.group(1))
   ...
   #
    ...
    headers['Cookie'] = b['Cookie']
    url = "http://v3-test-linux-passport.hd-cloud.com/themes/hayden/images/login/captcha.png"
    res = session.get(url=url, headers=headers, allow_redirects=False)
    #访问3-
    url = "http://v3-test-linux-portal.hd-cloud.com/login"
    res = session.get(url=url, headers=headers, allow_redirects=False)
    #print(res.headers)
    #print("3-",res.content)
    # 访问4-获取公key
    url = 'http://v3-test-linux-passport.hd-cloud.com/preLogin/getPubKey'
    res = session.get(url=url, headers=headers, allow_redirects=False)
    ...
    headers = {
        ...
        "Upgrade-Insecure-Requests": "1",
        "Origin": "http://v3-test-linux-passport.hd-cloud.com",
    ...
    data = "username=hdtest09&pwd1=" + pwd + "&captcha=&rememberMe=false&lt=" + it + "&execution=" + execution + "&_eventId=submit&module=pub-base&password=" + pwd
    ...
    headers = {
        ...
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8,zh-TW;q=0.7",
        "Cookie": "tenantCode=hd; module=portals; prjidentify=hd; jsessionid_portal=BE35E2D7C037E16DD7C0801A75F3FBE1"
    }

    b = {}
    b['Cookie'] = "tenantCode=hd; module=portals; prjidentify=hd; jsessionid_portal=" + first_cookie
    #print(b)
    headers['Cookie'] = b['Cookie']
    #print(headers)
    #6-
