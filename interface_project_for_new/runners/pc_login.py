...
def login():
    ...
    import json
    #访问1-主页
    url = 'http://v3-test-linux-portal.hd-cloud.com/'

    #访问主页的header
    headers = {
        "Host": "v3-test-linux-portal.hd-cloud.com",
   ...
   #访问2-302的header
    ...
    #print("3-",res.content)
    # 访问4-获取公key
    url = 'http://v3-test-linux-portal.hd-cloud.com/preLogin/getPubKey'
    res = session.get(url=url, headers=headers, allow_redirects=False)
    ...
    headers = {
        ...
        "Upgrade-Insecure-Requests": "1",
        "Origin": "http://v3-test-linux-portal.hd-cloud.com",
        "Content-Type": "application/x-www-form-urlencoded",
        "User-Agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36",
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        "Referer": "http://v3-test-linux-portal.hd-cloud.com/passports/login?service=http%3A%2F%2Fv3-test-linux-portal.hd-cloud.com%3A80%2Fportals%2Fcas&tenantCode=hd&trial=false",
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8,zh-TW;q=0.7",
    ...
    #拼接请求密码数据
    data = "username=admin2021&verifyPwd=" + pwd + "&captcha=&rememberMe=false&lt=" + it + "&execution=" + execution + "&_eventId=submit&module=pub-base&password=" + pwd
    ...
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36",
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        "Referer": "http://v3-test-linux-passport.hd-cloud.com/",
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8,zh-TW;q=0.7",
    ...
    url= 'http://v3-test-linux-portal.hd-cloud.com/portals/portals/hd'

    rs = requests.get(url=url, headers=headers)
    data = rs.content.decode('utf-8')

    url= 'http://v3-test-linux-portal.hd-cloud.com/portals/hd'
