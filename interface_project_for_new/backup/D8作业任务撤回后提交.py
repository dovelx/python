...
url = 'http://192.168.6.27:6030/hse/HSE_WORK_TASK_MCQ/withdraw?parentEntityId=&parentFuncCode=&topEntityId=%d&topFuncCode=HSE_WORK_TASK_MCQ&dataId=%d&0.6924403569632582&contentType=json&ajax=true&tid=1'%(num2,num2)
data = {
	"tableName": "hse_work_task",
	"task_worktype_code": "",
	"hasrescueplan": "",
