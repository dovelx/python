...
#cookies={'JSESSIONID': '1D324B900AB032D227E706F8D7C17FF8'}
...
req = requests.post(url=url3,data =data,headers = headers,allow_redirects=True)

cookies = requests.utils.dict_from_cookiejar(req.cookies)
headers = req.headers
print("second headers",headers)
#print (req.content)
print (cookies)
